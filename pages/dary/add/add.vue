<template>
	<view class="content-bg">
		...
		<view class="dary-title">
			<input v-model="from.title" auto-height placeholder="标题!不能超过20个字哦~" maxlength="20" />
		</view>
		<view class="dary-text">
			<textarea style="width: 100%;" v-model="from.content" placeholder="记录今日日记鸭!" maxlength="200"></textarea>
		</view>
